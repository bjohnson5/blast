...
test -f "$LIGHTNING_DIR/lightningd-regtest.pid" || \
    "/home/lightning/lightningd/lightningd" "--network=regtest" "--lightning-dir=$LIGHTNING_DIR" "--bitcoin-datadir=$BITCOIN_DIR" "--database-upgrade=true" "--grpc-port=$socketrpc"&
